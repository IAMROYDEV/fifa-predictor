    ...
    <div class="card">
        ...
        <div class="card-body text-left" style="padding: 20px;color: #000;font-weight: bold;">
            ...
            <ul>
            	...
            	<li>Once you select the squad of 11 player you need to lock the squad to start earing points.</li>
            	<li>The points are added to your account only when you lock the squad (Earlier the better to start collecting points from the first match).</li>
            ...
            <ul>
            	<li>You can earn more points by predicting the scores of each match</li>
			...
			<ul>
				...
				<li>Predict the winner of 2018 FIFA world cup correctly and earn <b>120</b>⭐ bonus points</li>
			...
			<ul>
				<li>There are 3 different competitions for which we will be giving away prizes</li>
