...
<div class="card">
    ...
    <div class="card-header">
        ...
        @endif
        <i class="fe fe-help-circle button-right" data-toggle="tooltip" data-placement="top" title="Select the team that you support :hearts: for the FIFA 2018 world cup!!"></i>
    </div>
    <div class="card-body">
